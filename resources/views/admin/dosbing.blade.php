        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="false">
            <div class="container-fluid py-1 px-3">
                ...
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-white active" aria-current="page">Dosen Pembimbing</li>
                </ol>
                <h6 class="font-weight-bolder text-white mb-0">Dosen Pembimbing</h6>
                </nav>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <a href="/admin/dosbing/add" class="btn btn-primary btn-sm ms-auto">Tambah Dosen Pembimbing</a>
                        </div>
                                ...
                                <table class="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Jumlah Bimbingan Mahasiswa</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <a href="/admin/dosbing/edit/{{ $p->id }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user"> Edit </a>
                                                <span class="text-secondary font-weight-bold text-xs"> | </span>
                                                <a href="/admin/dosbing/hapus/{{ $p->id }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Delet user"> Delete </a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
