            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <a href="/admin/sidang/add" class="btn btn-primary btn-sm ms-auto">Atur Sidang</a>
                    </div>
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    @foreach ($pembimbing as $p)
                                        @foreach ($p->mahasiswa->sortBy('nama_mhs') as $m)
                                            @if ($m->ta)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <a href="/admin/sidang/edit/{{ $m->ta->id }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user"> Edit </a>
                                                    <span class="text-secondary font-weight-bold text-xs"> | </span>
                                                    <a href="/admin/sidang/hapus/{{ $m->ta->id }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Delet user"> Delete </a>
                                                </td>
                                            </tr>
                                            @endif
                                        @endforeach
                                        ...
                                        @foreach ($p->mahasiswa->sortBy('nama_mhs') as $m)
                                            @foreach ($m->revisi as $r)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center text-sm">
                                                        <a href="/admin/sidang/revisi_download/{{ $r->id }}" class="btn badge badge-sm text-uppercase bg-gradient-warning mb-0">download</a>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        @if ($r->status == 'Lulus')
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <a href="/admin/sidang/revisi_edit/{{ $r->id }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user"> Ubah Status </a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @endforeach
